...
const compareLayout = async (htmlPath, options, handler) => {
    ...
    const htmlName = path_1.default.basename(htmlPath, '.html');
    const htmlDirname = path_1.default.dirname(htmlPath);
    const htmlPathCopy = path_1.default.join(htmlDirname, `${htmlName}-copy.html`);
